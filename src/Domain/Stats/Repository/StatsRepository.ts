        ...
        try {
            ...
            const res = await client.query(`
                SELECT
                    ...
                    (SELECT COUNT(*) FROM public.${Environment.env.TABLE_BEATMAP} WHERE status IN (-1,0,3) AND mode_int = 0) AS osu_bm_pending_count,
                    ...
                    (SELECT COUNT(*) FROM public.${Environment.env.TABLE_BEATMAP} WHERE status IN (-1,0,3) AND mode_int = 1) AS taiko_bm_pending_count,
                    ...
                    (SELECT COUNT(*) FROM public.${Environment.env.TABLE_BEATMAP} WHERE status IN (-1,0,3) AND mode_int = 2) AS fruits_bm_pending_count,
                    ...
                    (SELECT COUNT(*) FROM public.${Environment.env.TABLE_BEATMAP} WHERE status IN (-1,0,3) AND mode_int = 3) AS mania_bm_pending_count
            `);
